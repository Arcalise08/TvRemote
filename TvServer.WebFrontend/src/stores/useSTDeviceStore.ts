...
import {SmartThingsDevice, SmartThingsInputMap, STRemoteButtonCommand} from "../models/smart-thing-types.ts";
...
export interface DeviceStore {
  ...
  sendSTRemotePress: (device : STDevice, remotePress : STRemoteButtonCommand) => Promise<BasicResult>;
        ...
        persist(
            immer((set, get) => {
                ...
                return ({
                    ...
                    sendSTRemotePress: async (device : STDevice, press : STRemoteButtonCommand) => {
                        const client = initializeSTClient();
                        if (!client)
                            return {
                                isSuccessful: false,
